...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // com.example.vishad.afinal.MainActivity.SmsBroadcastReceiver smsBroadcastReceiver = new com.example.vishad.afinal.MainActivity.SmsBroadcastReceiver();
    ...
    public void onRequestPermissionsResult(int requestCode, String permissions[], int[] grantResults) {
        ...
        do {
            ...
            if (number.equals(i)) {
                ...
                Log.v("r",""+smsInboxcursor.getString(indexBody));
